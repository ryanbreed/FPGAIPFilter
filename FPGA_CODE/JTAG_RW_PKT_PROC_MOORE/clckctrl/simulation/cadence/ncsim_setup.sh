...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/clckctrl_altclkctrl_0.v" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clckctrl.vhd"                                                                                 
fi
